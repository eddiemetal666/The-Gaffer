...
- Use football terminology naturally (e.g. clean sheets, xG, pressing intensity, etc.)
- When suggesting accas, assess the weakest link and overall risk
- Always remind users to gamble responsibly when appropriate

Be conversational, knowledgeable, and engaging. You're like a well-informed mate who knows their football stats.`;
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          }}>AI Betting Analyst</div>
        </div>
        <div style={{ marginLeft: "auto", display: "flex", gap: 8, alignItems: "center" }}>
          <div style={{
            width: 8, height: 8, borderRadius: "50%",
            background: "#2d7a2d",
            boxShadow: "0 0 8px #2d7a2d",
      ...
      <div style={{
          ...
          <div style={{ animation: "fadeUp 0.5s ease" }}>
            ...
            <div style={{
              ...
              <p style={{
                ...
                Your personal AI football betting analyst. Ask me about form, fixtures, value bets, accas, and more.
              </p>
              <p style={{
                color: "#3a6a3a",
                fontSize: 11,
                ...
                letterSpacing: 1,
                textTransform: "uppercase",
              }}>⚠ Please gamble responsibly · 18+</p>
            </div>
            ...
            <div style={{
              ...
              {suggestions.map((s, i) => (
                <button key={i} onClick={() => sendMessage(s)} style={{
                  ...
                  onMouseEnter={e => {
                    e.currentTarget.style.background = "rgba(35,70,35,0.7)";
                    e.currentTarget.style.borderColor = "#2d7a2d";
                    e.currentTarget.style.color = "#c8e8c8";
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.background = "rgba(20,40,20,0.6)";
                    e.currentTarget.style.borderColor = "#1a3a1a";
                    e.currentTarget.style.color = "#a8c8a8";
                  }}
                >{s}</button>
              ))}
            </div>
          ...
          <div key={i} style={{
            ...
            <div style={{
              ...
              background: m.role === "user"
                ? "linear-gradient(135deg, #1a4a1a, #0f2f0f)"
                : "rgba(15,25,15,0.9)",
              ...
              whiteSpace: "pre-wrap",
              boxShadow: m.role === "user" ? "0 2px 12px rgba(45,122,45,0.15)" : "0 2px 12px rgba(0,0,0,0.3)",
            }}>
              {m.content}
            </div>
          </div>
        ...
        {loading && (
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 16, animation: "fadeUp 0.3s ease" }}>
            <div style={{
              width: 30, height: 30, borderRadius: "50%",
              background: "linear-gradient(135deg, #2d7a2d, #1a5c1a)",
      ...
      {/* Input */}
      <div style={{
        background: "linear-gradient(0deg, #0a0f0a 80%, transparent)",
        padding: "16px",
        position: "sticky",
        bottom: 0,
      }}>
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              transition: "all 0.2s",
              flexShrink: 0,
              boxShadow: input.trim() && !loading ? "0 0 12px rgba(45,122,45,0.3)" : "none",
            }}
          >➤</button>
        </div>
        <p style={{
          ...
          fontFamily: "monospace",
          letterSpacing: 0.5,
        }}>FOR ENTERTAINMENT PURPOSES · GAMBLE RESPONSIBLY · BEGAMBLEAWARE.ORG · 18+</p>
      </div>
    </div>
  );
}
